...
class LocationsViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case segueAddLocation:
            ...
            self.addLocationViewController = destination
        default:
            break
        }
    }
    ...
    @IBAction func clickAddLocation(_ sender: UIBarButtonItem) {
        performSegue(withIdentifier: segueAddLocation, sender: nil)
    }
